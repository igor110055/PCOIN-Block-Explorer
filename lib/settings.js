...
exports.dbsettings = {
  ...
  "password": "Ndsp2d77crrk33eBX!L",
  // database: The MongoDB database name (default: explorer)
  "database": "explorer",
...
exports.wallet = {
  ...
  "host": "localhost",
  // port: The port # that the wallet is configured to listen for RPC requests on (default: 22502 for PCOIN wallet)
  "port": 22502,
...
exports.shared_pages = {
  ...
  "page_title": "PCOIN Block Explorer",
...
exports.richlist_page = {
  ...
  "burned_coins": {
    ...
    "addresses": [ "PCOINBurnAddressXXXXXXXXXXXXXW7cDZQ" ],
...
exports.loadSettings = function loadSettings() {
  ...
  if (json_settings != null) {
    ...
    json_settings = fix_deprecated_setting(json_settings, 'display.charts_header_menu','charts_page.show_header_menu');
    ...
    json_settings = fix_deprecated_setting(json_settings, 'display.coinsupplyinfopnl', 'shared_pages.page_header.panels.coin_supply_info_panel.display_order');
    ...
    json_settings = fix_deprecated_setting(json_settings, 'public_api.rpc.getsupplyinfo', 'api_page.public_apis.rpc.getsupplyinfo.enabled');
